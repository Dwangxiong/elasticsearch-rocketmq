				 ...
				 .startObject()  
	                .startObject(type)
	                    .startObject("properties")
		                	...
		                	.startObject("mark").field("type", "string").field("store", "no").field("analyzer", "ik").field("searchAnalyzer", "ik").field("index_options", "offsets").endObject()
		                	.startObject("city")
		                		.field("type", "object")
		                		.startObject("properties")
			                		.startObject("uuid").field("type", "string").field("store", "no").field("analyzer", "ik").field("searchAnalyzer", "ik").endObject()
		                			.startObject("name").field("type", "string").field("store", "no").field("analyzer", "ik").field("searchAnalyzer", "ik").field("index_options", "offsets").endObject()
